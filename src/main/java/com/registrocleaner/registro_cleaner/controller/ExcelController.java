...
public class ExcelController {
    ...
    public ResponseEntity<byte[]> listFiles(@RequestParam String name) throws IOException {
        ...
        headersHttp.set(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename="+name);
